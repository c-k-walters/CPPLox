...
struct Binary: Expr, public enable_shared_from_this<Binary> {
	Binary(shared_ptr<Expr> left, Token op, shared_ptr<Expr> right): left{std::move(left)}, op{std::move(op)}, right{std::move(right)} {}
...
struct Unary: Expr, public enable_shared_from_this<Unary> {
	Unary(Token op, shared_ptr<Expr> right): op{std::move(op)}, right{std::move(right)} {}
